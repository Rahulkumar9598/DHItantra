        ...
        <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-white">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
                    ...
                    {/* Left Content (7 Cols) */}
                    <div className="text-center lg:text-left lg:col-span-7 mb-16 lg:mb-0">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 border border-slate-100 shadow-sm mb-8 transition-transform hover:scale-105 cursor-default">
                            <span className="flex text-yellow-400">
                                {[1, 2, 3, 4, 5].map(i => <Star key={i} size={14} fill="currentColor" />)}
                            </span>
                            <span className="text-sm font-semibold text-slate-600">Loved by 10,000+ Students</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-12">
                            <button
                                ...
                                className="w-full sm:w-auto px-8 py-4 bg-blue-600 text-white rounded-xl font-bold text-lg shadow-xl shadow-blue-200 hover:bg-blue-700 hover:shadow-2xl hover:-translate-y-1 transition-all flex items-center justify-center gap-2 group"
                            >
                            ...
                            <button
                                className="w-full sm:w-auto px-8 py-4 bg-white text-slate-700 border border-slate-200 rounded-xl font-bold text-lg hover:bg-slate-50 hover:border-slate-300 transition-all"
                            >
                                View Test Series
                            </button>
                        </div>
                        ...
                        {/* Trust Signals */}
                        <div className="flex items-center justify-center lg:justify-start gap-8 text-slate-400 grayscale opacity-70">
                            {/* Placeholders for partner logos/institutes could go here */}
