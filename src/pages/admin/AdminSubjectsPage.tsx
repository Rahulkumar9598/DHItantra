                            ...
                            <div className="space-y-3">
                                {subjects.length === 0 ? (
                                    ...
                                    subjects.map(subject => (
                                        <div key={subject.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-md border border-slate-200 p-4 bg-white">
                                            <div className="space-y-1">
                                                <div className="text-slate-900 font-semibold">{subject.name}</div>
                                                <div className="text-sm text-slate-500">ID: {subject.id}</div>
                                            </div>
                                            <div className="flex gap-2">
                                                <button
                                                    type="button"
                                                    onClick={() => handleEdit(subject)}
                                                    className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-slate-100 text-slate-700 hover:bg-slate-200 transition"
                                                >
                                                    <Edit2 size={16} />
                                                    Edit
                                                </button>
                                                <button
                                                    ...
                                                    className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-red-50 text-red-600 hover:bg-red-100 transition"
                                                >
                                                    <Trash2 size={16} />
                                                    Delete
                                                </button>
                    ...
                    <div className="bg-white rounded-md border border-slate-200 shadow-sm p-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            {DEFAULT_SUBJECTS.map(subject => (
                                <div key={subject} className="rounded-md border border-slate-200 px-4 py-3 bg-slate-50 text-sm text-slate-700">
                                    {subject}
                                </div>
                            ))}
                        </div>
                    ...
                    <form onSubmit={handleCreate} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 border border-slate-200 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500"
                            />
                        </div>
                        <button
                            type="submit"
                            disabled={isSaving}
                            className="inline-flex items-center justify-center w-full gap-2 rounded-md bg-teal-600 px-4 py-3 text-sm font-semibold text-white hover:bg-teal-700 transition"
                        >
                            <Plus size={18} />
                        ...
                        {editId && (
                            <button
                                ...
                                className="inline-flex items-center justify-center w-full gap-2 rounded-md border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition"
                            >
                                <X size={18} />
                                Cancel edit
                            </button>
                ...
                <div className="bg-white rounded-md border border-slate-200 shadow-sm p-6">
                    ...
                    <form onSubmit={handleUpdate} className="grid gap-4 sm:grid-cols-[1fr_auto]">
                        ...
                        <button
                            type="submit"
                            disabled={isSaving}
                            className="inline-flex items-center justify-center gap-2 rounded-md bg-teal-600 px-4 py-3 text-sm font-semibold text-white hover:bg-teal-700 transition"
                        >
                            <Save size={18} />
                            Save Changes
                        </button>
