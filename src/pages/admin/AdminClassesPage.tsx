                        ...
                        {isLoading ? (
                            ...
                            <div className="space-y-3">
                                {classes.length === 0 ? (
                                    ...
                                    classes.map(c => (
                                        <div key={c.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-md border border-slate-200 p-4 bg-white">
                    ...
                    <div className="bg-white rounded-md border border-slate-200 shadow-sm p-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            {DEFAULT_CLASSES.map(c => (
                                <div key={c} className="rounded-md border border-slate-200 px-4 py-3 bg-slate-50 text-sm text-slate-700">
                                    {c}
                                </div>
                            ))}
                        </div>
                ...
                <div className="bg-white rounded-md border border-slate-200 shadow-sm p-6">
                    ...
                    <form onSubmit={handleUpdate} className="grid gap-4 sm:grid-cols-[1fr_auto]">
                        ...
                        <button
                            type="submit"
                            disabled={isSaving}
                            className="inline-flex items-center justify-center gap-2 rounded-md bg-emerald-600 px-4 py-3 text-sm font-semibold text-white hover:bg-emerald-700 transition"
                        >
                            <Save size={18} />
                            Save Changes
                        </button>
